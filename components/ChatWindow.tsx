...
export function ChatWindow(props: {
  ...
  return (
    ...
    >
      <h2 className={`${messages.length > 0 ? "" : "hidden"} text-2xl m-2`}>
        {emoji} {titleText}
      </h2>
      {messages.length === 0 ? emptyStateComponent : ""}
      <div
        className="message-container flex flex-col-reverse w-full mb-4 overflow-auto transition-[flex-grow] ease-in-out"
      ...
      <form onSubmit={sendMessage} className="flex w-full flex-col">
        ...
        <div className="flex w-full mt-4">
          <input
            ...
            value={input}
            placeholder={placeholder ?? "What's the Punishment for bribery?"}
